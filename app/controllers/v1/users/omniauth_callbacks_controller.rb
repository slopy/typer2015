module DeviseTokenAuth
  class V1::Users::OmniauthCallbacksController < DeviseTokenAuth::ApplicationController
    ...
    def failure
      self.omniauth_failure
    end

    def google_oauth2
      self.omniauth_success
    end
    ...
    def render_data(message, data)
      ...
      render :layout => nil, :template => "v1/devise_token_auth/omniauth_external_window"
    end
    ...
    def get_resource_from_auth_hash
      ...
      @resource = resource_class.where({
        uid:      auth_hash['info']['email'] || auth_hash['uid'],
